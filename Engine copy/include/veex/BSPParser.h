...
private:
    ...
    // Note: Face-centric processing data (FacePolygon, FaceMaterialProperties, FaceBatch)
    // are defined in Face.h and used in BSP.cpp for rendering pipeline integration
};
