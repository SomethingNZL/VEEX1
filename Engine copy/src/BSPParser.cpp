...
uint32_t BSPParser::BuildLightmapAtlas()
{
    ...
    // ── Step 4: upload GL_RGB16F (Floating point linear HDR) ─────────────────
    ...
    // Upload raw HDR data directly - no LDR conversion or gamma correction here!
    // This keeps the data in linear space for the shader to handle correctly.
